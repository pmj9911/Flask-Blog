...
@login_required
def account():
    # form = User.query.get(username = current_user.username)
...
def send_reset_email(user):
    ...
    msg = Message('password reset',sender='n=admin@flaskblog.com', recipients=[user.email])
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('email sent. Reset password','info')
        return redirect(url_for('login'))
